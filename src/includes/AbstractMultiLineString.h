...
// $Id: AbstractMultiLineString.h 272 2007-01-06 19:37:27Z brian $
//
...
public:
    ...
    virtual Ref<AbstractCharReader> createCharReader() const;

    /// creates a new char reader owned by the caller
    virtual Ref<AbstractCharReader> createCharReader(const string &terminator) const;
};
