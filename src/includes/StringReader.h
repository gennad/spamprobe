...
// $Id: StringReader.h 272 2007-01-06 19:37:27Z brian $
//
...
class StringReaderPosition;

class StringReader : public AbstractCharReader
{
public:
    StringReader(const string &source);
