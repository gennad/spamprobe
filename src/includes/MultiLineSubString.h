...
// $Id: MultiLineSubString.h 272 2007-01-06 19:37:27Z brian $
//
...
{
public:
  MultiLineSubString(const CRef<AbstractMultiLineString> &target,
                     int start_index,
                     int limit_index = INT_MAX);
...
private:
  CRef<AbstractMultiLineString> m_target;
  int m_startIndex;
  int m_length;
};
